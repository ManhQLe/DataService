function Ctrl8(a){this._={};this._.Props=a?a:{};this._.Ctrls={}}Ctrl8.OfClass=Ctrl8;Ctrl8.ExtendsTo=function(a){function c(){}var b=this.OfClass;c.prototype=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.baseConstructor=b;a.superClass=b.prototype;a.OfClass=a;a.ExtendsTo=b.ExtendsTo};Ctrl8.prototype.Prop=function(a,c,b,d,e,f,g){Ctrl8.CreateProp(this,g||this._.Props,a,c,b,e,d,f)};Ctrl8.prototype.DrillProp=function(a,c,b){b?1:b=Ctrl8;Ctrl8.CreateProp(this,this._.Ctrls,a,new b(c),!0)};
Ctrl8.prototype.CpxProp=function(a,c,b){Ctrl8.CalcProp(this,this._.Props,a,function(a,b){return new c(b[a]||(b[a]={}))},b?null:function(a,b,c){c[b]=a})};Ctrl8.prototype.CalcProp=function(a,c,b,d,e){Ctrl8.CalcProp(this,e||this._.Props,a,c,b,d)};Ctrl8.DefCompareFx=function(a,c){return a===c};Ctrl8.DefChangeFx=function(a){};
Ctrl8.CreateProp=function(a,c,b,d,e,f,g,h){f?1:f=Ctrl8.DefCompareFx;g?1:g=Ctrl8.DefChangeFx;h={get:function(){return c[b]},configurable:h?!0:!1};e?1:h.set=function(a){f.call(this,c[b],a)?0:(c[b]=a,g.call(this,a))};Object.defineProperty(a,b,h);c.hasOwnProperty(b)||void 0===d?1:c[b]=d};Ctrl8.CalcProp=function(a,c,b,d,e,f){f={get:function(){return d.call(this,b,c)},configurable:f?!0:!1};e?f.set=function(a){e.call(this,a,b,c)}:1;Object.defineProperty(a,b,f)};
